...
export class MaterialsController {
  ...
  create(@Body() dto: CreateMaterialDto, @Req() req: Request & { user?: { username?: string } }) {
  ...
  update(@Param('id') id: string, @Body() dto: UpdateMaterialDto, @Req() req: Request & { user?: { username?: string } }) {
